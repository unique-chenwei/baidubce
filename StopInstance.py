...
if __name__ == "__main__":
    ...
    http_method = "PUT"
    # 接口请求路径
    path = "/v2/instance/i-MiHL3eZP"
    # 接口请求的header头
    headers = {
                "host": "bcc.bj.baidubce.com",
                "content-type": "application/json; charset=utf-8",
                "x-bce-date": "2019-04-28T04:24:49Z"
               }
    # 接口请求参数
    params = {
         "stop": ""
    ...
    # 设置到期时间，默认1800s
    expiration_in_seconds = 180000000
    # 设置参与鉴权的时间戳
    timestamp = 1556418303
    # 生成鉴权字符串
    ...
    # 拼接接口的url地址
    url = 'http://%s%s?stop' % (headers['host'], request['uri'])
